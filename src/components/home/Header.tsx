    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <h1 className="text-colorOne text-3xl font-bold">leMarché</h1>
          ...
          <div className="flex items-center space-x-6 text-sm ">
            <button className="bg-colorOne text-white px-4 py-2 rounded-full font-medium hover:bg-[#e64a19] transition-all duration-300">
                + Déposer une annonce
            </button>
            {session&&(<><div className="text-center cursor-pointer hover:text-colorOne duration-300 transition-all">
              ...
              <p>Favoris</p>
            </div><div className="text-center cursor-pointer hover:text-colorOne duration-300 transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 px-auto w-full">

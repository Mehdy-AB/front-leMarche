...
import { getBrandsByTypeName, getCities, getDepartments, getRegions } from "@/app/lib/req/ghost"
import { brands, cities, department, region } from "@/app/lib/types/types"
...
export default function QuickSearch(){
    ...
    <div className="flex flex-col  w-[40rem] items-center">
      <h1 className="text-4xl font-semibold text-gray-700">Recherche rapide</h1>
        ...
        <div className="flex relative flex-col w-[50rem] overflow-hidden items-center h-[32rem]">

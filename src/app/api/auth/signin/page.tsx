...
if(!session || !session?.user){
  return (
    <>
      ...
      <div className="flex flex-col justify-center w-[40rem] items-center">
      <h1 className="text-3xl text-gray-700">Create an account</h1>
      <h4 className="text-xs text-gray-500">Already have an account? 
        <a className="underline cursor-pointer">Log in</a>
      </h4>
        <div className="mt-12">
          <div className="grid grid-cols-2 gap-8 px-[100px]">
            <span className="w-full bg-gray-600 h-[1.6px]"></span>
            <span className="w-full bg-gray-300 h-[1.6px]"></span>
          </div>
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <button type="submit" onClick={()=>{setEtape(etape+1)}} className="bg-orange-400 rounded-4xl py-3 rounded-full mt-6 font-semibold text-white">Next</button>
